...
it is aimed straight at that gap.
  ...
  Step 3  : identical to Method A -- fixed-share dollar basket B_t = sum w_i P_i,
            two-point calibration, cointegration gate vs Kalshi (16:00 ET).
...
ROOT = os.path.dirname(os.path.dirname(HERE))          # repo root (Hasbrouck methodology/attempt2 -> Durf)
...
def main():
    ...
    #   (identical to Method A; only the weights differ)
    # ======================================================================
