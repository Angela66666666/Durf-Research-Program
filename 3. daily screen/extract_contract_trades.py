...
base_dir = PROJ_ROOT / "1. data" / "kalshi"
trades_glob = base_dir / "kalshi" / "trades" / "*.parquet"
# The 295 hand-curated contracts (folder "2. contract selection", Step 2) —
# the universe the study runs on.
ec = pd.read_csv(PROJ_ROOT / "2. contract selection" / "selected_contracts.csv")
...
# regression.py in this same folder reads this file, so write it right here.
out_path = HERE / "contract_daily_prices.csv"
